...
export default function YearButton({
  ...
  return (
    <button
      onClick={onClick}
      className={`rounded-lg text-center px-3 xs:px-4 py-1.5 xs:py-2 border border-transparent dark:hover:border-zinc-700 hover:border-zinc-200 duration-100 text-xs xs:text-sm font-medium ${
        year === currentYear
